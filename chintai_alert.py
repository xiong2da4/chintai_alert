...
rn = 2080
page = 1
slack_webhook_url = os.environ.get("SLACK_WEBHOOK")  # ← GitHub Actions の Secret から取得
csv_file = "properties.csv"

if not slack_webhook_url:
    raise ValueError("Slack Webhook URL が設定されていません。環境変数 SLACK_WEBHOOK を確認してください。")
...
while True:
    ...
    for prop in properties:
        ...
        for room in rooms:
            room_id_input = room.find('input', class_='js-clipkey')
